...
public class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    public void setCameraPreviewSize(int width, int height) {
        ...
        if (mIncomingWidth >= 2100) {
            bitrate = 14_000_000;
        } else if (mIncomingWidth >= 1000) {
            bitrate = 8_000_000;
        } else if (mIncomingWidth >= 720) {
            bitrate = 3_000_000;
        } else if (mIncomingWidth >= 480) {
            bitrate = 1_500_000;
        } else if (mIncomingWidth >= 360) {
            bitrate = 450_000;
        } else if (mIncomingWidth >= 288) {
            bitrate = 350_000;
        } else if (mIncomingWidth >= 240) {
            bitrate = 250_000;
