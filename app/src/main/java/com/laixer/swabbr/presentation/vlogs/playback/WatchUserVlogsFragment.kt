 ...
 *  and right to go to other vlogs. When entering this fragment, the
 *  entire fragment is filled with the [video_viewpager].
 *
 *  // TODO Generalize for any video list
 *  Currently this only works for the vlogs of a given user.
 *
 *  Note that this uses a view pager with id [video_viewpager] to handle
 *  swiping left and right. Each vlog itself is then inflated using a
 *  [WatchVlogFragmentAdapter].
 *
...
class WatchUserVlogsFragment : AuthFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        video_viewpager.apply {
            adapter = WatchVlogFragmentAdapter(this@WatchUserVlogsFragment, vlogListVm)
        }
