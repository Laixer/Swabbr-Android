 ...
 */
open class RecordVideoFragment2 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? =
        inflater.inflate(R.layout.fragment_record_video2, container, false)
    ...
    companion object {
        private val TAG = RecordVideoFragment2::class.java.simpleName
